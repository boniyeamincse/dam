...
export default function Create({ locations, vendors }) {
        ...
        <AppLayout title="Add Switch">
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900">Add Switch</h1>
                </div>
